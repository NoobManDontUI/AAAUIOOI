...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'nootnoot watch_dogs best script require'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Github Tool Admin"..ver
...
spawn(function()
	if pcall(function() loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/version'))() end) then
		if ver ~= Version then
			notify('Outdated','Get the new version at, ')
		end
		if Announcement and Announcement ~= '' then
			...
			PopupText.Font = Enum.Font.SourceSans
			PopupText.TextSize = 14
			PopupText.Text = "Notice by HyrsKaitou"
			PopupText.TextColor3 = currentText1
			PopupText.TextWrapped = true
